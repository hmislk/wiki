...
## Last Update - 2025.08.15 02:57 - (Buddhika)
...
CREATE TABLE PRESCRIPTION (ID BIGINT NOT NULL, ADMINISTRATIONSTARTEDAT DATETIME, ADMINISTRATIONSTOPREASON VARCHAR(255), ADMINISTRATIONSTOPPEDAT DATETIME, ALLERGIES VARCHAR(255), CLINICALINDICATION VARCHAR(255), COMMENT VARCHAR(255), CONTINUEONDISCHARGE TINYINT(1) default 0, CONTRAINDICATIONS VARCHAR(255), CREATEDAT DATETIME, DISCHARGEDATE DATETIME, DISCHARGEINSTRUCTIONS VARCHAR(255), DISPENSEDAT DATETIME, DISPENSEDQUANTITY DOUBLE, DISPENSINGNOTES VARCHAR(255), DOSE DOUBLE, DOSESGIVEN INTEGER, DOSESREMAINING INTEGER, DURATION DOUBLE, EDITEDAT DATETIME, INDOOR TINYINT(1) default 0, INTERACTIONS VARCHAR(255), ISSUE DOUBLE, LASTREVIEWEDAT DATETIME, MONITORINGPLAN VARCHAR(255), OMISSIONREASON VARCHAR(255), OMITTEDAT DATETIME, ORDERNO DOUBLE, PRESCRIBEDAT DATETIME, PRESCRIBEDFROM DATETIME, PRESCRIBEDTO DATETIME, PRESCRIPTIONSTATUS VARCHAR(255), PRIORITY VARCHAR(255), PRN TINYINT(1) default 0, PRNINDICATION VARCHAR(255), REQUIRESNURSEADMINISTRATION TINYINT(1) default 0, REQUIRESPHARMACISTREVIEW TINYINT(1) default 0, RETIRECOMMENTS VARCHAR(255), RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, ROUTE VARCHAR(255), SIDEEFFECTSTOMONITOR VARCHAR(255), THERAPEUTICGOAL VARCHAR(255), TOTALDOSES INTEGER, VERIFIEDAT DATETIME, WORKFLOWSTAGE VARCHAR(255), ADMINISTRATIONSTARTEDBY_ID BIGINT, ADMINISTRATIONSTARTEDDEPARTMENT_ID BIGINT, ADMINISTRATIONSTOPPEDBY_ID BIGINT, ADMINISTRATIONSTOPPEDDEPARTMENT_ID BIGINT, CATEGORY_ID BIGINT, CREATER_ID BIGINT, DEPARTMENT_ID BIGINT, DISCHARGEREVIEWEDBY_ID BIGINT, DISPENSEDBY_ID BIGINT, DISPENSINGDEPARTMENT_ID BIGINT, DOSEUNIT_ID BIGINT, DURATIONUNIT_ID BIGINT, EDITER_ID BIGINT, ENCOUNTER_ID BIGINT, FREQUENCYUNIT_ID BIGINT, INSTITUTION_ID BIGINT, ISSUEUNIT_ID BIGINT, ITEM_ID BIGINT, LASTREVIEWEDBY_ID BIGINT, OMITTEDBY_ID BIGINT, OMITTINGDEPARTMENT_ID BIGINT, PARENT_ID BIGINT, PATIENT_ID BIGINT, PRESCRIBEDBY_ID BIGINT, PRESCRIBINGDEPARTMENT_ID BIGINT, RETIRER_ID BIGINT, REVIEWINGDEPARTMENT_ID BIGINT, VERIFIEDBY_ID BIGINT, VERIFYINGDEPARTMENT_ID BIGINT, WEBUSER_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE BILL (ID BIGINT NOT NULL, DTYPE VARCHAR(31), ACCEPTEDAT DATETIME, AGENTREFNO VARCHAR(255), APPOINTMENTAT DATETIME, APPROVEAT DATETIME, BALANCE DOUBLE, BILLCLASSTYPE VARCHAR(255), BILLCLOSED TINYINT(1) default 0, BILLDATE DATE, BILLPAYMENTCOMPLETELYSETTLED TINYINT(1) default 0, BILLTIME DATETIME, BILLTOTAL DOUBLE, BILLTYPE VARCHAR(255), BILLTYPEATOMIC VARCHAR(255), BILLERFEE DOUBLE, BOOKINGID VARCHAR(255), CANCELLED TINYINT(1) default 0, CASHBALANCE DOUBLE, CASHPAID DOUBLE, CATID VARCHAR(255), CHECKEAT DATETIME, CHEQUEDATE DATE, CHEQUEREFNO VARCHAR(255), CLAIMABLETOTAL DOUBLE, COLLCTINGCENTREFEE DOUBLE, COMMENTS LONGTEXT, COMPLETED TINYINT(1) default 0, COMPLETEDAT DATETIME, CONSIGNMENT TINYINT(1) default 0, CREATEDAT DATETIME, CREDITBILL TINYINT(1) default 0, CREDITCARDREFNO VARCHAR(255), CREDITDURATION INTEGER, DEPTID VARCHAR(255), DISCOUNT DOUBLE, DISCOUNTPERCENT DOUBLE, DUPLICATEPRINTEDAT DATETIME, DUPLICATEDPRINTED TINYINT(1) default 0, EDITEDAT DATETIME, EXPENSETOTAL DOUBLE, EXPENSESTOTALCONSIDEREDFORCOSTING DOUBLE, EXPENSESTOTALNOTCONSIDEREDFORCOSTING DOUBLE, EXTERNALDOCTOR VARCHAR(255), FREEVALUE DOUBLE, FROMDATE DATETIME, FULLYISSUED TINYINT(1) default 0, FULLYISSUEDAT DATETIME, GRANTTOTAL DOUBLE, GRNNETTOTAL DOUBLE, HOSPITALFEE DOUBLE, INDICATION LONGTEXT, INSID VARCHAR(255), INVOICEDATE DATE, INVOICENUMBER VARCHAR(255), IPOPORCC VARCHAR(255), LOCALNUMBER VARCHAR(255), MARGIN DOUBLE, NETTOTAL DOUBLE, PAID TINYINT(1) default 0, PAIDAMOUNT DOUBLE, PAIDAT DATETIME, PAYMENTAPPROVALCOMMENTS LONGTEXT, PAYMENTAPPROVED TINYINT(1) default 0, PAYMENTAPPROVEDAT DATETIME, PAYMENTCOMPLETED TINYINT(1) default 0, PAYMENTCOMPLETEDAT DATETIME, PAYMENTCOMPLETIONCOMMENTS LONGTEXT, PAYMENTGENERATED TINYINT(1) default 0, PAYMENTGENERATEDAT DATETIME, PAYMENTGENERATIONCOMMENTS LONGTEXT, PAYMENTMEMO LONGTEXT, PAYMENTMETHOD VARCHAR(255), PERFORMINSTITUTIONFEE DOUBLE, PRINTED TINYINT(1) default 0, PRINTEDAT DATETIME, PROFESSIONALFEE DOUBLE, QTY DOUBLE, QUTATIONNUMBER VARCHAR(255), REACTIVATED TINYINT(1) default 0, REFERENCENUMBER VARCHAR(255), REFUNDAMOUNT DOUBLE, REFUNDED TINYINT(1) default 0, RELEASEDAT DATETIME, RETIRECOMMENTS VARCHAR(255), RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, SALEVALUE DOUBLE, SERVICECHARGE DOUBLE, SESSIONID VARCHAR(255), SETTLEDAMOUNTBYPATIENT DOUBLE, SETTLEDAMOUNTBYSPONSOR DOUBLE, SMSED TINYINT(1) default 0, SMSEDAT DATETIME, STAFFFEE DOUBLE, STATUS INTEGER, SURGERYBILLTYPE VARCHAR(255), TAX DOUBLE, TENDEREDAMOUNT DOUBLE, TODATE DATETIME, TOTAL DOUBLE, TOTALCENTERFEE DOUBLE, TOTALHOSPITALFEE DOUBLE, TOTALSTAFFFEE DOUBLE, VAT DOUBLE, VATPLUSNETTOTAL DOUBLE, APPROVEUSER_ID BIGINT, BACKWARDREFERENCEBILL_ID BIGINT, BANK_ID BIGINT, BILLPACKEGE_ID BIGINT, BILLEDBILL_ID BIGINT, CANCELLEDBILL_ID BIGINT, CATEGORY_ID BIGINT, CHECKEDBY_ID BIGINT, COLLECTINGCENTRE_ID BIGINT, COMPLETEDBY_ID BIGINT, CREATER_ID BIGINT, CREDITCOMPANY_ID BIGINT, DEPARTMENT_ID BIGINT, DUPLICATEPRINTEDUSER_ID BIGINT, EDITOR_ID BIGINT, FORWARDREFERENCEBILL_ID BIGINT, FROMDEPARTMENT_ID BIGINT, FROMINSTITUTION_ID BIGINT, FROMSTAFF_ID BIGINT, FROMWEBUSER_ID BIGINT, FULLYISSUEDBY_ID BIGINT, INSTITUTION_ID BIGINT, ITEM_ID BIGINT, MEMBERSHIPSCHEME_ID BIGINT, PAIDBILL_ID BIGINT, PATIENT_ID BIGINT, PATIENTENCOUNTER_ID BIGINT, PAYMENTAPPROVEDBY_ID BIGINT, PAYMENTCOMPLETEDBY_ID BIGINT, PAYMENTGENERATEDBY_ID BIGINT, PAYMENTSCHEME_ID BIGINT, PAYMENTSCHEMEINSTITUTION_ID BIGINT, PERSON_ID BIGINT, PRINTEDUSER_ID BIGINT, PROCEDURE_ID BIGINT, REACTIVATEDBILL_ID BIGINT, REFERENCEBILL_ID BIGINT, REFERENCEINSTITUTION_ID BIGINT, REFERREDBY_ID BIGINT, REFERREDBYINSTITUTION_ID BIGINT, REFERRINGDEPARTMENT_ID BIGINT, REFUNDEDBILL_ID BIGINT, RETIRER_ID BIGINT, SINGLEBILLITEM_ID BIGINT, SINGLEBILLSESSION_ID BIGINT, SMSEDUSER_ID BIGINT, STAFF_ID BIGINT, TODEPARTMENT_ID BIGINT, TOINSTITUTION_ID BIGINT, TOSTAFF_ID BIGINT, TOWEBUSER_ID BIGINT, WEBUSER_ID BIGINT, BANKACCOUNT_ID BIGINT, BILLFINANCEDETAILS_ID BIGINT UNIQUE, CASHTRANSACTION_ID BIGINT, ONLINEBOOKING_ID BIGINT, PHARMACYBILL_ID BIGINT, STOCKBILL_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE PHARMACEUTICALBILLITEM (ID BIGINT NOT NULL, AFTERADJUSTMENTEXPIRY DATE, AFTERADJUSTMENTVALUE DOUBLE, BARCODE VARCHAR(255), BEFOREADJUSTMENTEXPIRY DATE, BEFOREADJUSTMENTVALUE DOUBLE, CHASSISNO VARCHAR(255), CODE VARCHAR(255), COLOUR VARCHAR(255), COSTRATE DOUBLE, COSTRATEPACK DOUBLE, COSTVALUE DOUBLE, CREATEDAT DATETIME, DEPRECITIONRATE DOUBLE, DESCRIPTION LONGTEXT, DOE DATE, ENGINENO VARCHAR(255), FREEQTY DOUBLE, FREEQTYPACKS DOUBLE, LASTPURCHASERATE DOUBLE, LASTPURCHASERATEPACK DOUBLE, MODEL VARCHAR(255), NUMBEROFACCESSORIES INTEGER, OTHERNOTES LONGTEXT, PURCHASERATE DOUBLE, PURCHASERATEPACK DOUBLE, PURCHASERATEPACKVALUE DOUBLE, PURCHASEVALUE DOUBLE, QTY DOUBLE, QTYPACKS DOUBLE, REGISTRATIONNO VARCHAR(255), REMAININGFREEQTY DOUBLE, REMAININGFREEQTYPACK DOUBLE, REMAININGQTY DOUBLE, REMAININGQTYPACK DOUBLE, RETAILPACKVALUE DOUBLE, RETAILRATE DOUBLE, RETAILRATEPACK DOUBLE, RETAILVALUE DOUBLE, RETIRECOMMENTS LONGTEXT, RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, SERIALNO VARCHAR(255), STRINGVALUE VARCHAR(255), TOTALACQUICITIONCOST DOUBLE, WARRENTYCERTIFICATENUMBER VARCHAR(255), WARRENTYDURATION BIGINT, WHOLESALERATE DOUBLE, WHOLESALERATEPACK DOUBLE, CREATER_ID BIGINT, ITEMBATCH_ID BIGINT, MAKE_ID BIGINT, MANUFACTURER_ID BIGINT, RETIRER_ID BIGINT, STAFFSTOCK_ID BIGINT, STOCK_ID BIGINT, BILLITEM_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE HISTORICALRECORD (ID BIGINT NOT NULL, COMPLETED TINYINT(1) default 0, COMPLETEDAT DATETIME, CREATEDAT DATETIME, FROMDATETIME DATETIME, HISTORICALRECORDTYPE VARCHAR(255), RECORDDATE DATE, RECORDDATETIME DATETIME, RECORDVALUE DOUBLE, RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, STARTEDAT DATETIME, TODATETIME DATETIME, VARIABLENAME VARCHAR(255), COLLECTIONCENTRE_ID BIGINT, CREATEDBY_ID BIGINT, DEPARTMENT_ID BIGINT, INSTITUTION_ID BIGINT, RETIREDBY_ID BIGINT, SITE_ID BIGINT, WEBUSER_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE INSTITUTION (ID BIGINT NOT NULL, COLLECTINGCENTREPAYMENTMETHOD VARCHAR(255), ACCOUNTNO VARCHAR(255), ADDRESS VARCHAR(255), AGENTBALANCE DOUBLE, ALLOWEDCREDIT DOUBLE, ALLOWEDCREDITLIMIT DOUBLE, BALLANCE DOUBLE, BANKNAME VARCHAR(255), BRANCHNAME VARCHAR(255), CASHIERBILLHEADING LONGTEXT, CHEQUEPRINTINGNAME VARCHAR(255), CODE VARCHAR(255), COMPANYBALANCE DOUBLE, CONTACTPERSONNAME VARCHAR(255), CREATEDAT DATETIME, DESCREPTION LONGTEXT, EMAIL VARCHAR(255), EMAILSENDINGPASSWORD VARCHAR(255), EMAILSENDINGUSERNAME VARCHAR(255), FAX VARCHAR(255), INACTIVE TINYINT(1) default 0, INSTITUTIONCODE VARCHAR(255), INSTITUTIONTYPE VARCHAR(255), INWARDDISCOUNT DOUBLE, LABBILLDISCOUNT DOUBLE, LABBILLHEADING LONGTEXT, LEGALCOMPANY VARCHAR(255), MAXCREDITLIMIT DOUBLE, MOBILE VARCHAR(255), NAME VARCHAR(255), OPDBILLDISCOUNT DOUBLE, OPDBILLHEADING LONGTEXT, OWNEREMAIL VARCHAR(255), OWNERNAME VARCHAR(255), PAYMENTCOMPANYNAME VARCHAR(255), PERCENTAGE DOUBLE, PHARMACYBILLHEADING LONGTEXT, PHARMACYDISCOUNT DOUBLE, PHONE VARCHAR(255), POINTOFISSUENO VARCHAR(255), QBSUPPLIERNAME VARCHAR(255), RADIOLOGYBILLHEADING LONGTEXT, RETIRECOMMENTS VARCHAR(255), RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, SMSSENDINGALIAS VARCHAR(255), SMSSENDINGPASSWORD VARCHAR(255), SMSSENDINGUSERNAME VARCHAR(255), STANDARDCREDITLIMIT DOUBLE, WEB VARCHAR(255), BANKBRANCH_ID BIGINT, CONTACTPERSON_ID BIGINT, CREATER_ID BIGINT, FEELISTTYPE_ID BIGINT, INSTITUTION_ID BIGINT, LABDEPARTMENT_ID BIGINT, LABINSTITUTION_ID BIGINT, PARENTINSTITUTION_ID BIGINT, RETIRER_ID BIGINT, ROUTE_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE BILLNUMBER (ID BIGINT NOT NULL, BILLCLASSTYPE VARCHAR(255), BILLTYPE VARCHAR(255), BILLTYPEATOMIC VARCHAR(255), BILLYEAR INTEGER, LASTBILLNUMBER BIGINT, OPDANDINPATIENTSERVICEBATCHBILLS TINYINT(1) default 0, OPDANDINPATIENTSERVICEBILLS TINYINT(1) default 0, PAYMENTMETHOD VARCHAR(255), RETIRECOMMENTS VARCHAR(255), RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, DEPARTMENT_ID BIGINT, INSTITUTION_ID BIGINT, RETIRER_ID BIGINT, TODEPARTMENT_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE WEBUSERPASSWORDHISTORY (ID BIGINT NOT NULL, CREATEDAT DATETIME, PASSWORD VARCHAR(255), RETIRECOMMENTS VARCHAR(255), RETIRED TINYINT(1) default 0, RETIREDAT DATETIME, CREATER_ID BIGINT, RETIRER_ID BIGINT, WEBUSER_ID BIGINT, PRIMARY KEY (ID))
...
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_VERIFIEDBY_ID FOREIGN KEY (VERIFIEDBY_ID) REFERENCES WEBUSER (ID)
...
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_VERIFYINGDEPARTMENT_ID FOREIGN KEY (VERIFYINGDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
...
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_OMITTINGDEPARTMENT_ID FOREIGN KEY (OMITTINGDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_ADMINISTRATIONSTARTEDBY_ID FOREIGN KEY (ADMINISTRATIONSTARTEDBY_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_ADMINISTRATIONSTOPPEDDEPARTMENT_ID FOREIGN KEY (ADMINISTRATIONSTOPPEDDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_RETIRER_ID FOREIGN KEY (RETIRER_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_DISCHARGEREVIEWEDBY_ID FOREIGN KEY (DISCHARGEREVIEWEDBY_ID) REFERENCES WEBUSER (ID)
...
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_REVIEWINGDEPARTMENT_ID FOREIGN KEY (REVIEWINGDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
...
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_ADMINISTRATIONSTOPPEDBY_ID FOREIGN KEY (ADMINISTRATIONSTOPPEDBY_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_ADMINISTRATIONSTARTEDDEPARTMENT_ID FOREIGN KEY (ADMINISTRATIONSTARTEDDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_DISPENSEDBY_ID FOREIGN KEY (DISPENSEDBY_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_DISPENSINGDEPARTMENT_ID FOREIGN KEY (DISPENSINGDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_OMITTEDBY_ID FOREIGN KEY (OMITTEDBY_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_PRESCRIBINGDEPARTMENT_ID FOREIGN KEY (PRESCRIBINGDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_EDITER_ID FOREIGN KEY (EDITER_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_PRESCRIBEDBY_ID FOREIGN KEY (PRESCRIBEDBY_ID) REFERENCES WEBUSER (ID)
ALTER TABLE PRESCRIPTION ADD CONSTRAINT FK_PRESCRIPTION_LASTREVIEWEDBY_ID FOREIGN KEY (LASTREVIEWEDBY_ID) REFERENCES WEBUSER (ID)
...
ALTER TABLE BILL ADD CONSTRAINT FK_BILL_FULLYISSUEDBY_ID FOREIGN KEY (FULLYISSUEDBY_ID) REFERENCES WEBUSER (ID)
...
ALTER TABLE FEE ADD CONSTRAINT FK_FEE_FORDEPARTMENT_ID FOREIGN KEY (FORDEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
...
ALTER TABLE PATIENTSAMPLE ADD CONSTRAINT FK_PATIENTSAMPLE_SAMPLESENTTODEPARTMENT_ID FOREIGN KEY (SAMPLESENTTODEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
...
ALTER TABLE PATIENTSAMPLE ADD CONSTRAINT FK_PATIENTSAMPLE_SAMPLESENTTOINSTITUTION_ID FOREIGN KEY (SAMPLESENTTOINSTITUTION_ID) REFERENCES INSTITUTION (ID)
...
ALTER TABLE PAYMENTSCHEME ADD CONSTRAINT FK_PAYMENTSCHEME_DEPARTMENT_ID FOREIGN KEY (DEPARTMENT_ID) REFERENCES DEPARTMENT (ID)
...
ALTER TABLE UPLOAD ADD CONSTRAINT FK_UPLOAD_HISTORICALRECORD_ID FOREIGN KEY (HISTORICALRECORD_ID) REFERENCES HISTORICALRECORD (ID)
...
ALTER TABLE WEBUSERPASSWORDHISTORY ADD CONSTRAINT FK_WEBUSERPASSWORDHISTORY_CREATER_ID FOREIGN KEY (CREATER_ID) REFERENCES WEBUSER (ID)
ALTER TABLE WEBUSERPASSWORDHISTORY ADD CONSTRAINT FK_WEBUSERPASSWORDHISTORY_WEBUSER_ID FOREIGN KEY (WEBUSER_ID) REFERENCES WEBUSER (ID)
ALTER TABLE WEBUSERPASSWORDHISTORY ADD CONSTRAINT FK_WEBUSERPASSWORDHISTORY_RETIRER_ID FOREIGN KEY (RETIRER_ID) REFERENCES WEBUSER (ID)
